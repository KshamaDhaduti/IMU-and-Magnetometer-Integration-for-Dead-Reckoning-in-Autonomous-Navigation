...
title("Magnetometer(X and Y) readings")
...
figure
plot(mag_x1,mag_y1)
title("Magnetometer X vs Y plot for circular motion readings ")
xlabel("Magnetometer X reading(Gauss)")
ylabel("Magnetometer Y reading(Gauss)")
grid on
...
title("Magnetometer X vs Y plot after Hard iron effect correction")
xlabel("Magnetometer X reading(Gauss)")
ylabel("Magnetometer Y reading(Gauss)")
grid on
...
v_1=lowpass(v_1,0.9);
plot(v_1(1,:),v_1(2,:));
title('Magnetometer X vs Y plot after adjustments for Soft Iron effects'); 
xlabel('Magnetometer X reading(Gauss)'); 
ylabel('Magnetometer Y reading(Gauss)');
grid on
...
title('Yaw calculated from Magnetometer, Gyro, and Orientation'); 
...
hold on
plot(unwrap(yaw_eul));
title('Yaw calculated using Complimentary filter from Orientation'); 
...
title('GPS and IMU Velocity'); legend('GPS Velocity','IMU Velocity');xlabel('Time'); ylabel('Velocity');
hold off
...
title('Acceleration of y_dot_dot_observed and w*X_dot'); legend('w*X_dot','y_dot_dot_observed');xlabel('Time'); ylabel('Acceleration');
hold off
...
title('Displacements obtained from GPS and IMU (X-axis)'); legend('GPS','IMU');xlabel('Time'); ylabel('X-axis/UTM Easting');
hold off
...
title('Displacements obtained from GPS and IMU (Y-axis)'); legend('GPS','IMU');xlabel('Time'); ylabel('Y-axis/UTM Northing');
hold off
...
title('Trajectories obtained from GPS and IMU'); legend('IMU','GPS');xlabel('X-axis/UTM Easting'); ylabel('Y-axis/UTM Northing');
